        ...
        >
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul>
                    ...
                    <li class="relative px-6 py-3">
                        <NavLink
                            :href="route('advertise-collection.index')"
                            :active="
                                url.startsWith('/advertise-collection')
                                    ? true
                                    : false
                            "
                        >
                            ...
                            <span class="ml-4">Advertise Collection</span>
                        </NavLink>
                    </li>

                    <li class="relative px-6 py-3">
                        <NavLink
                            :href="route('revenue-advertise.index')"
                            :active="
                                url.startsWith('/revenue-advertise')
                                    ? true
                                    : false
                            "
                        >
                            ...
                            <span class="ml-4">Revenue Advertise</span>
                        </NavLink>
                    </li>
                    ...
                    <li class="relative px-6 py-3">
                        <NavLink
                            ...
                            :active="url.startsWith('/websites') ? true : false"
                        >
                            <svg
                                class="w-5 h-5"
                                fill="none"
                            ...
                            <span class="ml-4">Websites</span>
                        </NavLink>
                    </li>

                    <li class="relative px-6 py-3">
                        <NavLink
                            :href="route('alias-collection.index')"
                            :active="
                                url.startsWith('/alias-collection')
                                    ? true
                                    : false
                            "
                        >
                            ...
                            <span class="ml-4">Data Alias</span>
                        </NavLink>
                    </li>
                </ul>
            </div>
