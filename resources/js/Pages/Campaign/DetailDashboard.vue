        ...
        <div class="bg-white overflow-visible shadow-sm sm:rounded-lg">
          <div class="px-4 py-3 mb-8 rounded-lg">
            <div class="flex space-x-4 overflow-visible">
              <div class="basis-2/4">
                <div class="dropdown">
                  <label tabindex="0" class="m-1 btn">Filter Graph</label>
                  <ul
                    tabindex="0"
                    class="
                      p-2
                ...
                <div class="dropdown">
                  <label tabindex="0" class="m-1 btn">Export</label>
                  <ul
                    tabindex="0"
                    class="
                      p-2
          ...
          <div class="collapse-content">
            <div class="px-4 py-3 mb-8 rounded-lg">
              ...
              <div class="flex flex-wrap mt-2">
                <div v-for="(filters, index) in filterings">
                  <div class="mr-4 mb-2">
                    <button class="btn" @click="removeFiltering(index)">
                      <svg
        ...
        <table class="w-full mt-3 whitespace-no-wrap">
          ...
          >
            <tr
              ...
              :key="index"
            >
              <td class="px-4 py-3 text-sm hover:text-blue-500" @click="redirectPage(item.campaign.camp_id)">
                {{item.campaign.name}}  
              </td>
...
export default {
  props: ["statistics", "campaigns", "columns", "operators"],
  components: {
    BreezeAuthenticatedLayout,
    Head,
    Link,
