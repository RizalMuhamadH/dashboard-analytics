<template>
    <Head title="Advertise Collection" />
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="my-6 flex space-x-3">
            <Link
                :href="route('advertise-collection.create')"
            ...
            <Link
                :href="route('advertise-collection.import')"
                :class="'px-4 py-2 font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple'"
            >
                Import
            </Link>
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        ...
                        >
                            ...
                            <th class="px-4 py-3">Advertise</th>
                    ...
                    >
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-sm"> {{ item.views }} </td>
                            <td class="px-4 py-3 text-sm"> {{ item.rpm }} </td>
                            <td class="px-4 py-3 text-sm"> {{ item.revenue }} </td>
