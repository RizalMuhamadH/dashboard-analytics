<template>
    <Head title="Advertise Collection Import" />

    <BreezeAuthenticatedLayout>
        <h2
            class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"
        >
            Import Advertise Collection
        </h2>

        <div
            class="md:w-2/5 w-full my-4 justify-self-center text-white bg-purple-600 rounded-lg shadow-xs px-3 py-4"
        >
            <input
            ...
            />
            <div
                class="flex h-40 border-2 border-white border-dashed rounded-lg items-center justify-center text-xl"
                @drop="handleDrop"
        ...
        <div class="my-6" v-if="excelData.header != null">
...
export default {
    ...
    methods: {
        uploadData() {
            ...
            this.form.post(this.route("advertise-collection.store_import"), {
                onFinish: () =>
                    (this.excelData = {
                        header: null,
                        results: null,
